...
In addition, in \Cref{fig:essence2} there is the implied constraint states that very operation in the program is occurring exactly once in an execution then the length of the execution is exactly the number of all operations of all cores in the program.
